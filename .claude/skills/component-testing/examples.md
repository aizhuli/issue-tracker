...
1. **Arrange** — set up data via harness methods
2. **Act** — call the HTTP endpoint
3. **Assert** — verify the HTTP response and side effects

**Common patterns:**
- Reset fixture in `IAsyncLifetime.InitializeAsync()`
- Create `Act<T>()` helper methods
- Use fixture helper methods for authentication
- Verify both the response and DB state
- Test authorization and validation
- Use harness for all external dependencies
